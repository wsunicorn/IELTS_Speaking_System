...
> Có thể tham khảo (nhưng **hãy tự kiểm tra độ tin cậy/an toàn trước khi cài**) một số skill cộng đồng đang phổ biến 2026: skill WebGPU/Three.js, skill Material Design 3, "Claude Design" chạy local. Ưu tiên tự viết skill ngắn gọn cho đúng dự án thay vì cài nhiều skill lạ.
...
- **Canva**: tạo/chuẩn bị asset thiết kế, thumbnail, hình minh họa.
- **Google Drive**: lưu/đọc tài liệu, đề bài, bản plan này.
